...
const Terms = props => {
  const { contactEmail, trademarksUrl } = props
  ...
  return (
    <>
      ...
      <p>All Turtles Corporation has the right but not the obligation to monitor and edit all Content provided by users.</p>
      <p>In addition, Content found on or through this Service are the property of All Turtles Corporation or used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole or in part, for commercial purposes or for personal gain, without express advance written permission from us.</p>
      <h4>Accounts</h4>
      ...
      <p>The Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of All Turtles Corporation and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries. Our <a href={trademarksUrl}>trademarks</a> and trade dress may not be used in connection with any product or service without the prior written consent of All Turtles Corporation.</p>
      <h4>Links To Other Web Sites</h4>
      <p>Our Service may contain links to third party web sites or services that are not owned or controlled by All Turtles Corporation</p>
      <p>All Turtles Corporation has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.</p>
...
Terms.propTypes = {
  ...
  trademarksUrl: PropTypes.string
}

Terms.defaultProps = {
  contactEmail: 'hello@all-turtles.com',
  trademarksUrl: 'https://all-turtles.com/trademarks'
}
